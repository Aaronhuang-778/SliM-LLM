...
class QuantOPTAttention(nn.Module):
    ...
    def __init__(
        ...
        self.k_proj = QuantLinear(
            ...
            attention_precision["self_attn.k_proj"],
        )
        self.v_proj = QuantLinear(
            org_module.v_proj,
            args.weight_quant_params,
            args.act_quant_params,
            attention_precision["self_attn.v_proj"],
        )
        self.q_proj = QuantLinear(
            org_module.q_proj,
            args.weight_quant_params,
            args.act_quant_params,
            attention_precision["self_attn.q_proj"],
        )
        self.out_proj = QuantLinear(
            org_module.out_proj, args.weight_quant_params, args.act_quant_params, attention_precision["self_attn.out_proj"]
        )
...
class QuantOPTDecoderLayer(nn.Module):
    def __init__(
        ...
        self.self_attn = QuantOPTAttention(
            ...
            args=args,
            attention_precision=decoderlayer_precision,
        )
        ...
        self.fc1 = QuantLinear(
            ...
            block_precision=decoderlayer_precision["fc1"],
        )
        self.fc2 = QuantLinear(
            ori_layer.fc2,
            weight_quant_params=args.weight_quant_params,
            act_quant_params=args.act_quant_params,
            block_precision=decoderlayer_precision["fc2"],
        )
